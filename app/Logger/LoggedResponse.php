...
class LoggedResponse
{
    ...
    protected function skipByStatus(): bool
    {
        ...
        return Str::is(config()->get('cloakr.skip_body_log.status'), $this->response->getStatusCode());
    }
    ...
    protected function skipByExtension(): bool
    {
        ...
        return Str::is(config()->get('cloakr.skip_body_log.extension'), $this->request->getUri()->getPath());
    }
