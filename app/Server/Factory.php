...
class Factory
{
    ...
    protected function bindDatabase()
    {
        app()->singleton(DatabaseInterface::class, function() {
            ...
            return $factory->openLazy(base_path('database/cloakr.db'));
        });
    }
    ...
    {
        config()->set('cloakr.validate_auth_tokens', $validate);
