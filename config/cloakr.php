...
return [
    ...
    */
    ...
    'admin' => [
        ...
        |--------------------------------------------------------------------------
        |
        | The SQLite database that your cloakr server should use. This database
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | By default, once you start an cloakr server, anyone is able to connect to
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Control if you want to allow users to share TCP ports with your Cloakr
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Cloakr allows you to also share TCP ports, for example when sharing your
        | local SSH server with the public. This setting allows you to define the
        | port range that Cloakr will use to assign new ports to the users.
        |
        ...
        */
        ...
        | stay connected to the cloakr server, you can specify the maximum
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | The default messages that the cloakr server will send the clients.
        | These settings can also be changed at runtime in the cloakr admin
        | interface.
        |
        */
        'messages' => [
            ...
            'tcp_port_sharing_disabled' => 'TCP port sharing is not available on this Cloakr server.',
        ],
