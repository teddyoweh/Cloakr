...
To configure the Cloakr client, you first need to publish the configuration file.
...
The configuration file will be written to your home directory inside a `.cloakr` folder:
...
```bash
EXPOSE_CONFIG_FILE="~/my-custom-config.php" cloakr share
```
