...
class TunnelTest extends TestCase
{
    ...
    {
        $this->app['config']['cloakr.admin.validate_auth_tokens'] = false;
        ...
        /**
         * We create an cloakr client that connects to our server and shares
    ...
    public function it_rejects_tcp_sharing_if_disabled()
    {
        ...
        $this->app['config']['cloakr.admin.allow_tcp_port_sharing'] = false;
    ...
    public function it_rejects_tcp_sharing_if_forbidden()
    {
        ...
        $this->app['config']['cloakr.admin.validate_auth_tokens'] = true;
    ...
    public function it_rejects_clients_with_too_many_connections()
    {
        $this->expectException(\UnexpectedValueException::class);
        $this->app['config']['cloakr.admin.validate_auth_tokens'] = false;
        $this->app['config']['cloakr.admin.maximum_open_connections_per_user'] = 1;
    ...
    public function it_rejects_users_with_custom_max_connection_limit()
    {
        $this->expectException(\UnexpectedValueException::class);
        $this->app['config']['cloakr.admin.validate_auth_tokens'] = true;
        $this->app['config']['cloakr.admin.maximum_open_connections_per_user'] = 5;
    ...
    {
        $this->app['config']['cloakr.admin.subdomain'] = 'cloakr';
        $this->app['config']['cloakr.admin.database'] = ':memory:';

        $this->app['config']['cloakr.admin.users'] = [
            'username' => 'secret',
        ];
